...
public interface BeerControllerDocs {
    ...
    @ApiOperation(value = "Beer create operation")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Return beer found by a given name")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Delete a beer found by a given vali id")
    @ApiResponses(value = {
            @ApiResponse(code = 204, message = "Success beer deleted in the system" ),
            @ApiResponse(code = 404, message = "Beer with given not found." )
    })
